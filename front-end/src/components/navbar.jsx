...
const Navbar = () => {
  ...
  let signUp = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch("https://food-delivery-site-22lt.vercel.app/api/users/signUp", {
        method: "POST",
        headers: {
  ...
  let signIn = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch("https://food-delivery-site-22lt.vercel.app/api/users/signIn", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
