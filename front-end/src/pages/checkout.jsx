...
const Checkout = () => {
  ...
  let getcredentials = async()=>{
    let response = await fetch("https://food-delivery-site-22lt.vercel.app/api/users/getcredentials",{
      method:"get",
      headers:{
  ...
  const makePayment = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://food-delivery-site-22lt.vercel.app/api/users/create-checkout-session`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
