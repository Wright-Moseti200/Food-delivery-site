...
const AddProduct = () => {
  ...
  let addproduct = async (e)=>{
    ...
    await fetch("https://food-delivery-site-22lt.vercel.app/api/product/upload",{
      method:"post",
      body:formData1
    ...
    if(responseData.success){
      formData.image_url=responseData.image_url;
       await fetch("https://food-delivery-site-22lt.vercel.app/api/product/receiveProductData",{
        method:"post",
        headers:{
