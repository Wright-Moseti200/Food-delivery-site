...
const Orders = () => {
  ...
  const fetchAllOrders = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://food-delivery-site-22lt.vercel.app/api/product/getusersorders");
  ...
  const updateOrderStatus = async (orderId, newStatus) => {
    try {
      const response = await fetch("https://food-delivery-site-22lt.vercel.app/api/product/updateorderstatus", {
        method: "PUT",
        headers: {
